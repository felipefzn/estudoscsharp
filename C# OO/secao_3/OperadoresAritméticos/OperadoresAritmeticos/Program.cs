...
namespace OperadoresAritmeticos {
    class Program {
        static void Main(string[] args) {
            ...
            int n2 = (3 + 4) * 2;
            int resultado = n1 + n2;
            double n4 = (double)10.0 / 8; //se fizer uma expressão que vai dar numero quebrado, com numeros inteiros o compilador vai colocar o resultado em int. pra arrumar isso, colocar o (double) na frente ou transformar o numero em decimal ex: 10.0
